    ...
    <div className="hoverable-icon">
      <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clip-path="url(#clip0_9_106)">
          ...
          />
          <path d="M11.5055 20.7056H17.4098" stroke="current" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M14.4577 20.7056V13.6388H12.4896" stroke="current" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path
